...
return [
    ...
    'filled'               => ':Attribute je vyžadovaný.',
    'gt'                   => [
    ...
    'required_if'          => ':Attribute je vyžadovaný keď :other je :value.',
    'required_unless'      => ':Attribute je vyžadovaný, okrem prípadu keď :other je v :values.',
    'required_with'        => ':Attribute je vyžadovaný keď :values je prítomné.',
    'required_with_all'    => ':Attribute je vyžadovaný ak :values je nastavené.',
    'required_without'     => ':Attribute je vyžadovaný keď :values nie je prítomné.',
    'required_without_all' => ':Attribute je vyžadovaný ak žiadne z :values nie je nastavené.',
