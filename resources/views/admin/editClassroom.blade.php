        ...
        <div class="w-full mt-6 ml-6 bg-white p-6 rounded-tl-lg" >
            <form method="POST" action="{{ route('classroom.update', $classroom) }}">
                ...
                <div class="mb-4">
                    ...
                    <input class="h-10 bg-white border border-gray-300 rounded py-4 px-3 mr-4 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0" type="text" id="name" name="name" value="{{ $classroom->name }}">
                </div>
