        ...
        <div class="w-full mt-6 ml-6 bg-white p-6 rounded-tl-lg" >
            <form method="POST" action="{{ route('classroom.update', $classroom) }}">
                ...
                <div class="mb-4">
                    ...
                    <input class="bg-gray-100 border-2 w-full p-4 text-gray-600 rounded-lg focus:outline-none focus:border-gray-400 focus:ring-0 hover:border-gray-300 @error('name') border-red-500 @enderror" type="text" id="name" name="name" value="{{ $classroom->name }}">
                    @error('name')
