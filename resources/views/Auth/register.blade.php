        ...
        <div class="w-4/12 bg-white p-6 rounded-lg" >
            <form action="{{ route('register')}}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="fname" placeholder="Tvoje Meno" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('fname') border-red-500 @enderror" value="{{ old('name') }}">
                    @error('fname')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="lname" placeholder="Tvoje Priezvysko" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('lname') border-red-500 @enderror" value="{{ old('name') }}">
                    @error('lname')
                        <div class="text-red-500 mt-2 text-sm">
                            {{$message}}
                        </div>
